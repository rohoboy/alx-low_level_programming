...
/**
 * shash_table_get - a function that retrieves value associeted with key
 * @ht: a pointer to the hash table
 * @key: a key to retrive a value
 *
...
/**
 * shash_table_print - a function that prints a key:value from hash table
...
/**
 * shash_table_delete - a function to free hash table and all nodes
